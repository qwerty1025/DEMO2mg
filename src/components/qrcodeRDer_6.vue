...
{{ pLv_Name }}
            ...
            <v-tabs-items v-model="tab">
                ...
                <v-tab-item key='tab-44' value='tab-44'>   
...
<!-- https://i.imgur.com/5PapiZa.png
                                             ...
                                             <v-expansion-panel > 
                                                    <div class="grid grid-cols-3 gap-0.5">  
                                                        <!-- <div class="col-span-3 row-span-1">   -->
                                                                ...
                                                                <br>
                                                                <a class="col-span-1">{{ card.key }} </a>
 
                                                                    <v-text-field
                                                                        v-model="card.tm_Name"
                                                                        label="隊名" 
                                                                        filled dense class="px-3 col-span-2" 
                                                                    ></v-text-field>

                                                                    <v-text-field
                                                                        v-model="card.tm_amt"
                                                                        type="number" label="人數" 
                                                                        filled  dense class="px-2 col-span-1" 
                                                                    ></v-text-field>
                                                                    <v-text-field  
  ...
  -->
                ...
                <v-tab-item key='tab-5' value='tab-5'>
                    <v-card flat class="overflow-y-auto mb-20" height="500" >  
                          
                            <div class="m-3"   >
                                <v-row dense v-for="(item,index) in History"
                                      :key="index" >
                                    <div class="" v-show="item.statu != 2 "> 
                                    <!-- <div class="grid grid-cols-2 gap-1"> -->
                                        <!-- <div class="col-span-2" > <a class="text-gray-500 text-base" > 輸入“ {{ card.tm_Name }} “分數 </a>   </div> -->
...
export default {
    ...
    //        const OLD = {  
    //         statu: item.statu, 
    //         play_score: item.play_score, 
    //        }; 

    //        playLvService.update(item.key, OLD)
    //            .then(() => { 
    //             Swal.fire({
    //                    position: 'top-end',
    //                    icon: 'success',
    ...
    mounted() {
        ...
        // playLvService.getByDate('2022-10-16').on("value", this.playLvonDataChange);
